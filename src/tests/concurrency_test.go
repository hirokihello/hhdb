...
func TestConcurrency(t *testing.T) {
	...
	t.Run("thread a", func(t *testing.T) {
		t.Parallel()
		txA := transaction.Transaction(fileManeger, LogManager, bufferManager)
	...
	t.Run("thread b", func(t *testing.T) {
		t.Parallel()
		txB := transaction.Transaction(fileManeger, LogManager, bufferManager)
	...
	t.Run("thread c", func(t *testing.T) {
		t.Parallel()
		txC := transaction.Transaction(fileManeger, LogManager, bufferManager)
